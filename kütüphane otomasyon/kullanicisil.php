...
<div class="sidebar">
    ...
    <form action="kullanicisil.php" method="post">
        <div class="bilgi_ks" role="group" >
            <h1>Kullanıcı Sil</h1>
            <input type="text" placeholder="Kullanıcı Adı" name="uname"> <br> <br>
            <input type="text" placeholder="Kullanıcı Soyadı" name="usname"> <br> <br>
    ...
    if(isset($_POST["resetle"])){
        ...
        $sql = "DELETE FROM kullanici WHERE user_name='".$uname."'";
