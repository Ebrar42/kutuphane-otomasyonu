...
<div class="sidebar">
    ...
    <form action="kitapsil.php" method="post">
        <div class="bilgi" role="group" >
            <h1>Kitap Sil</h1>
            <input type="text" placeholder="Kitap Adı" name="bname"> <br> <br>
            <input type="text" placeholder="Yazar Adı" name="wname"> <br> <br>
            <input type="text" placeholder="Yayınevi" name="pubname"> <br> <br>
            <input type="text" placeholder="Sayfa Sayısı" name="page"> <br> <br>
            <input type="text" placeholder="Kitap Türü" name="genre"> <br> <br>

            <button class="btn1 btn btn-danger" name="resetle" type="submit" >Sil</button>
        </div>
    </form>
    <?php
    if(isset($_POST["resetle"])){
        ...
        $sql = "DELETE FROM books WHERE book_name='".$bname."' ";
